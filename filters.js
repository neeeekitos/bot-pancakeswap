...
const filters = {
    ...
    checkCreatorWallet: async (data, pairCreated) => {
        ...
        let url =  'http://api.covalenthq.com/v1/56/tokens/'+ pairCreated.newTokenAddr + '/token_holders/?' + get_request_args;
        let urlLP =  'http://api.covalenthq.com/v1/56/tokens/'+ pairCreated.pairAddr + '/token_holders/?' + get_request_args;
